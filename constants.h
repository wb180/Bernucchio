...
const std::array<int, 5> kPieceValue = {{ 119,
                                          401,
                                          432,
                                          612,
                                          1243
...
const std::array<int, kBitBoardSize> kPstBlackPawns = {{
        0,   0,   0,   0,   0,   0,   0,   0,
       55,  73,  95,  59,  73,  43,  61,  48,
       45,  42,  27,  94,  83,  64,  54,  31,
        5,  15,  10,   6,  21,  14,  19,   8,
      -24,  -6,  -5,  24,   9,   7,  16, -23,
      -21, -31,  -3, -10,   6, -12,   7, -14,
      -12, -10, -18, -51, -29,   9,  17, -14,
        0,   0,   0,   0,   0,   0,   0,   0}};
...
const std::array<int, kBitBoardSize> kPstBlackKnights = {{
     -49, -43, -25, -40, -37, -30, -27, -48,
     -51, -26,   7, -15,  -3,  30, -30, -25,
     -29,   2,  20,  66,  19,  17,  15, -30,
     -27,  18, -22,  53,  61,  60,  36, -26,
     -30,  16,  30,  17,  41,  55,  -5, -34,
     -52,  -9,   6,  30,  16,   1,  -7, -35,
     -54, -39, -10, -11,  -6,  -6, -21, -74,
     -56, -69, -35, -48, -61, -29, -40, -40}};
...
const std::array<int, kBitBoardSize> kPstBlackBishops = {{
     -27,  -4,   8,  -3, -14,  -8, -23, -17,
       0,  13,  48,  22,  -9,   9,   6, -20,
      -3,  -7,  22,   3,  16,  25,   9, -24,
      -8,  21,  22,  22,   3,  23,   8,  26,
      -4,  17,  16,  16,  24,  -5, -49,  -9,
     -11,   7,   8,  11,   3,  -6,  21,  -5,
     -11,  20,  17, -11, -14,  17,   7, -19,
     -13, -11, -46, -49, -13, -38,  -5, -33}};
...
const std::array<int, kBitBoardSize> kPstBlackRooks = {{
       8,  12,  36,  14,  11,  -4,  18,  -7,
      35,  27,   9,  38,  37,  31, -16,  -4,
       2,  18,   0,  14,  14,  -5,  13,  21,
       9,   1,  10,  -1,  -3,  40,  -9,  -5,
      -8,   7, -17,   1,   0,   1,  -7,  -4,
     -12,   2,   1, -11,   6,   5, -16, -14,
     -17,  -3, -42, -14, -36, -44,  10,  -3,
     -26,  -8,  -6,   2,   8,  -6,   4, -23 }};
...
const std::array<int, kBitBoardSize> kPstBlackQueens = {{
        -12, -12, -12,   6,   5, -17, -17, -18,
          2,   2,  13,  19,   3,  45,  25,   3,
        -38,  -1,  12,  16,  30,  43,  31, -11,
         12, -24,  -2,  23,  -3,  13,   5,  59,
         -5, -46,  -3,  11,  11,  -7,  21,  -6,
        -15, -14,  10, -19,  13,  -4,  -7, -17,
        -11, -11, -22,  -4,  -9,   2, -16, -11,
        -23,  -5,  -8,  -8, -18, -30,  -2, -12}};
...
const std::array<int, kBitBoardSize> kPstBlackKing = {{
      -40, -34, -47, -51, -52, -41, -31, -29,
      -23, -23, -39, -42, -41, -45, -53, -32,
      -23, -36, -35, -45, -41, -32, -11, -38,
      -14, -43, -26, -23, -24,  -6, -30, -32,
      -19, -22, -23, -32,   5, -31, -14, -35,
       -6,  -7, -11, -35,   1,   2,   3,  20,
        7,  15,   1,   4, -19,  -1,  19,  21,
       27,  23, -12, -77, -36,  -5,  31,  10}};
